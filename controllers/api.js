...
exports.getGithub = function(req, res, next) {
  github.findOne({}, {}, { sort: { '_id' : -1 } }).lean().then(function(data) {
    res.json(data);
  }).catch(function(err) {
    return next(err);
  });
...
exports.getTrakt = function(req, res, next) {
  trakt.findOne({}, {}, { sort: { '_id' : -1 } }).lean().then(function(data) {
...
exports.getFuelly = function(req, res, next) {
  ...
  fuelly.find(by, {}, { sort: { '_id' : -1 } }).lean().then(function(data) {
    res.json(data);
  }).catch(function(err) {
    return next(err);
  });
...
exports.getFuellyAvg = function(req, res, next) {
  ...
  const filter = { "fillTime": { "$gte": start, "$lte": end } };

  fuelly.find(filter, {}, { sort: { '_id' : -1 } }).lean().then(function(data) {
    const retData = {
      totalGallons: 0,
      totalMiles: 0,
      totalPrice: 0,
